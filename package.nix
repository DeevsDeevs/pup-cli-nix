...
let
  ...
  sources = {
    "aarch64-darwin" = {
      ...
      hash = "sha256-c+j7FIDC2QlMp7zGIOnBkwhJcmPBdyATS6zV7ETdqQ4=";
    };
    "x86_64-darwin" = {
      asset = "pup_${version}_Darwin_x86_64.tar.gz";
      hash = "sha256-pCrcQReVXCKQyI1Ox9R73qJ8BXCKWtxXlycKJH7ThLM=";
    };
    "aarch64-linux" = {
      asset = "pup_${version}_Linux_arm64.tar.gz";
      hash = "sha256-aJu9Lo4qKvFvyIjhDURq6laB8Nyi6QJgF9fy14TLbsY=";
    };
    "x86_64-linux" = {
      asset = "pup_${version}_Linux_x86_64.tar.gz";
      hash = "sha256-0RGUMztNvBwZTYNDhx4j20iVgeOtF9fv3k45UbtYXoY=";
    };
  };
