...
let
  ...
  sources = {
    "aarch64-darwin" = {
      ...
      hash = "sha256-CqCaemM/+PvooH2/GemgdnC9kVIzcf4tMlqrjKVlzkw=";
    };
    "x86_64-darwin" = {
      asset = "pup_${version}_Darwin_x86_64.tar.gz";
      hash = "sha256-Hg/OnliVu8egcGlUOQiLjBYtwC0+Jv31HSeKyKD7ODU=";
    };
    "aarch64-linux" = {
      asset = "pup_${version}_Linux_arm64.tar.gz";
      hash = "sha256-HUvcfriuLVeGfJwAhhZakpmlf1EM7mGCzKCom1eRhhk=";
    };
    "x86_64-linux" = {
      asset = "pup_${version}_Linux_x86_64.tar.gz";
      hash = "sha256-vl+oaNOTN8NzxCq9QHP2rPv/n5fxI1GRWJS9ez9Mjsc=";
    };
  };
