...
let
  ...
  sources = {
    "aarch64-darwin" = {
      ...
      hash = "sha256-PHoCLDRbT2DbHl164PbvmkXGcjIOvNlWxScT4dPwDvI=";
    };
    "x86_64-darwin" = {
      asset = "pup_${version}_Darwin_x86_64.tar.gz";
      hash = "sha256-SLoleaPLURoKCWSyrRPfGvf/e0ZUAt9IkuWMvv8l0AI=";
    };
    "aarch64-linux" = {
      asset = "pup_${version}_Linux_arm64.tar.gz";
      hash = "sha256-3zCYXRjUbRWUOcsqpte9Oz4b3+g0cWFLW0d1GAqzVi4=";
    };
    "x86_64-linux" = {
      asset = "pup_${version}_Linux_x86_64.tar.gz";
      hash = "sha256-b1/p79O0bGizQ2mAXgSNf708oKv80AS5mFBfDHIy/K8=";
    };
  };
