...
let
  ...
  sources = {
    "aarch64-darwin" = {
      ...
      hash = "sha256-n5+Vqn0xfnS90fSKgZVlB/5ttCZzwwt/ohlHimo2kkU=";
    };
    "x86_64-darwin" = {
      asset = "pup_${version}_Darwin_x86_64.tar.gz";
      hash = "sha256-lsuVxNW2GRdB4hJbC39dxPoKQ2EwEgQQprcmQH7QOEA=";
    };
    "aarch64-linux" = {
      asset = "pup_${version}_Linux_arm64.tar.gz";
      hash = "sha256-EaxTzLkPmGn6p+uvLHWktRa6Us6V7qn9VdCRC7UhYr0=";
    };
    "x86_64-linux" = {
      asset = "pup_${version}_Linux_x86_64.tar.gz";
      hash = "sha256-DK+jBENVIgsCsALBqOL/7H82CgoKXlnqwKVtxg5Zwcc=";
    };
  };
