...
let
  ...
  sources = {
    "aarch64-darwin" = {
      ...
      hash = "sha256-py1xuEeOU1XMZzF3ygBZKmBFcRfoPklPGdLNkIXe//s=";
    };
    "x86_64-darwin" = {
      asset = "pup_${version}_Darwin_x86_64.tar.gz";
      hash = "sha256-I2DBeZ25wZFnkdjW4niD4ArgMTknhXBw6AMHvFlF8Rg=";
    };
    "aarch64-linux" = {
      asset = "pup_${version}_Linux_arm64.tar.gz";
      hash = "sha256-WP8yJnXJkvSJtGDoweVKfceO2lpoCv92PZlmmQhSPdY=";
    };
    "x86_64-linux" = {
      asset = "pup_${version}_Linux_x86_64.tar.gz";
      hash = "sha256-52jzgfIPxO3n61vFXOAVtUWFYgX0t9h7QNPHrqvUDas=";
    };
  };
